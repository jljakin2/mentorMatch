...
app.post("/register", function (req, res) {
  User.register({
      ...
      areasForDev: req.body.areasForDev,
      areasOfExp: req.body.areasOfExp,
...
app.get("/personal-info/edit", function (req, res) {
...
app.post("/personal-info/edit", function (req, res) {
  User.updateOne({
    _id: req.user._id
  }, {
